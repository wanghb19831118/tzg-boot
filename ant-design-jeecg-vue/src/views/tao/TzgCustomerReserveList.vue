<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="负责人id">
              <a-input placeholder="请输入负责人id" v-model="queryParam.userid"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
    ...
    <!-- 表单区域 -->
    <tzgCustomerReserve-modal ref="modalForm" @ok="modalFormOk"></tzgCustomerReserve-modal>
  </a-card>
</template>

<script>
  import TzgCustomerReserveModal from './modules/TzgCustomerReserveModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'

  export default {
    name: "TzgCustomerReserveList",
    mixins:[JeecgListMixin],
    components: {
      TzgCustomerReserveModal
    },
    data () {
      return {
        description: '储备客户表管理页面',
        // 表头
        columns: [
          {
            title: '#',
