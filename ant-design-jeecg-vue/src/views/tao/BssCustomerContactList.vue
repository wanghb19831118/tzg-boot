<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <BssCustomerContact-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/tao/bssCustomer/listBssCustomerContactByMainId",
          delete: "/tao/bssCustomer/deleteBssCustomerContact",
          deleteBatch: "/tao/bssCustomer/deleteBatchBssCustomerContact",
        }
      }
    },
    methods: {
