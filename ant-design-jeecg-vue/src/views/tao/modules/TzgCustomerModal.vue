  ...
  export default {
    ...
    data() {
      return {
        ...
        validatorRules: {},
        url: {
          add: '/tao/tzgCustomer/add',
          edit: '/tao/tzgCustomer/edit',
          tzgCustomerShopList: '/tao/tzgCustomer/queryTzgCustomerShopByMainId',
          tzgCustomerContactList: '/tao/tzgCustomer/queryTzgCustomerContactByMainId',
          tzgCustomerCashAccountList: '/tao/tzgCustomer/queryTzgCustomerCashAccountByMainId'
        }
      }
    },
    methods: {
